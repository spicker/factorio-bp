...
var _user$project$Data_Entity_RequestFilter$RequestFilter = F2(
	function (a, b) {
		return {count: a, name: b};
	});
var _user$project$Data_Entity_RequestFilter$empty = A2(_user$project$Data_Entity_RequestFilter$RequestFilter, 0, '');
var _user$project$Data_Entity_RequestFilter$decoder = A3(
	_elm_lang$core$Json_Decode$map2,
	_user$project$Data_Entity_RequestFilter$RequestFilter,
...
var _user$project$Data_Entity_Module$decoder = A2(
	_elm_lang$core$Json_Decode$map,
...
var _user$project$Data_Entity$decoder = function () {
	...
	return A4(
		...
		A2(
			...
			_user$project$Data_Entity_RequestFilter$decoder),
		_elm_lang$core$Dict$empty,
		A4(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$optional,
			'items',
...
var _user$project$Data_Tile$empty = _user$project$Data_Tile$Tile('');
var _user$project$Data_Tile$decoder = A2(
	_elm_lang$core$Json_Decode$map,
...
var _user$project$Data_Blueprint$BlueprintBook = function (a) {
	return {ctor: 'BlueprintBook', _0: a};
};
...
var _user$project$Data_Blueprint$encodeBlueprint = function (bp) {
...
var _user$project$View_Grid$gridItem2 = F2(
	function (ges, entity) {
		var str = F3(
			function (s, a, b) {
				return A2(
			...
			function (pos, size) {
				return {
					...
					_0: _elm_lang$core$Basics$floor(
						pos - (_elm_lang$core$Basics$toFloat(size - 1) / 2)),
		...
		var _p1 = function () {
			...
			var xs = _p2._0;
			var ys = _p2._1;
			var _p3 = entity.direction;
			switch (_p3) {
				case 0:
					return {ctor: '_Tuple2', _0: xs, _1: ys};
				case 2:
					return {ctor: '_Tuple2', _0: ys, _1: xs};
				case 4:
					return {ctor: '_Tuple2', _0: xs, _1: ys};
				case 6:
					return {ctor: '_Tuple2', _0: ys, _1: xs};
		...
		var xe = _p5._0;
		var ye = _p5._1;
		var _p6 = A2(fromTo, xe, xs);
		var x1 = _p6._0;
		var x2 = _p6._1;
		var _p7 = A2(fromTo, ye, ys);
		var y1 = _p7._0;
		var y2 = _p7._1;
		return A2(
...
var _user$project$View_Grid$init = function (_p8) {
	var _p9 = _p8;
	...
	var _p10 = center(_p9._0);
	var nn = _p10._0;
	var np = _p10._1;
	var _p11 = center(_p9._1);
	var mn = _p11._0;
	var mp = _p11._1;
...
var _user$project$View_Grid$view = F2(
	function (bp, ge) {
		var gridStr = F3(
			function (str, x, acc) {
				return A2(
		...
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				_user$project$View_Grid$gridItem2(ge),
...
var _user$project$Main$LoadGameEntities = {ctor: 'LoadGameEntities'};
...
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Ports$inflated(_user$project$Main$InflatedValue);
};
var _user$project$Main$EncodeBlueprint = {ctor: 'EncodeBlueprint'};
var _user$project$Main$NewBlueprint = {ctor: 'NewBlueprint'};
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_user$project$View_Grid$view, model.blueprint, model.gameEntities),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
